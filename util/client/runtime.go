...
// WithDO method added to have ability to do local queries in tests
func (r *Runtime) WithDO(do func(ctx context.Context, client *http.Client, req *http.Request) (*http.Response, error)) *Runtime {
	r.do = do
	return r
}
